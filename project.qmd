...
## 🎥 Teaser Video: Forest Fire Project

<video width="720" controls style="display: block; margin: 0 auto; border-radius: 16px; box-shadow: 0 0 8px rgba(0,0,0,0.4); margin-bottom: 20px;">
...
ggplot(neden_df, aes(x = yil, y = number, fill = cause)) +
  geom_area(alpha = 0.8) +
  labs(
    title = "  Fire Cause Distribution Between 1988-2023 (Stacked Area Chart)",
    x = "Year",
    y = "Number of Fires",
    fill = "Cause of Fire"
  ) +
